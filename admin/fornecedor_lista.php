...
<table width="720" border="1px" class="borda_tabela" cellspacing="2">
  ...
  <tr class="ordenacao_novo_registro">
    <td width="225"><a href="index.php?tabela=fornecedor&acao=listar&ordem=FOR_RAZAOSOCIAL">Razao Social </td>
...
<?php 
  ...
  <tr class="titulos_lista_pesquisa">
    <td colspan="5"><p>Numero de registros: <?php echo $oquefazer->total_registros();?></p>
    </td>
  </tr>
</table>
