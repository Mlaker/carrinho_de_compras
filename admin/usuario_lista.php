...
<body>
<table width="720" border="1px" class="borda_tabela" cellspacing="2">
  ...
  <?php
    ...
    ?>
            <tr onmouseover="muda_cor_over(this)" onmouseout="muda_cor_out(this)">
                ...
                <td class="alterar_excluir"width="61"><a href="index.php?tabela=usuario&acao=alterar&codigo=<?php echo $oquefazer->registros->USU_CODIGO;?>">Alterar</a></td>
...
<?php 
  ...
  <tr class="titulos_lista_pesquisa">
    <td colspan="5"><p>Numero de registros: <?php echo $oquefazer->total_registros();?>
    </td>
  </tr>
</table>
</body>
